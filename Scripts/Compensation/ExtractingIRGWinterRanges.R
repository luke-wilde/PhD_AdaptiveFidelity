#Code for extracting mean IRG on winter seasonal ranges
...
#Import all winter ranges
d<-readOGR("D:/WYO_COOP/RedDesertToHobackDataMuleDeerProject/DissertationChapters/Chapter1_CatchingTheGreenWave/Data/WinterRange/KUDs","RD2H_WinterSeasonalRanges_95KUD_2011_thru_2020")
head(d)
d$id_yr<-d$id
...
all.winter.IRG<-rbind(df.11,df.12,df.14,df.16,df.17,df.18,df.19,df.20)

write.csv(all.winter.IRG,"D:/WYO_COOP/RedDesertToHobackDataMuleDeerProject/DissertationChapters/Chapter1_GWH_AmongMigratoryStrategies/Data/WinterRange/IRG/IRGWinterSeasonalRanges.csv")

#Clean working environment
rm(list=ls())

#Now extract IRG for population scale winter range for year year
d.11<-readOGR("D:/WYO_COOP/RedDesertToHobackDataMuleDeerProject/DissertationChapters/Chapter1_GWH_AmongMigratoryStrategies/Data/WinterRange/KUDs","PopLevel_WinterSeasonalRanges_95KUD_2011")
d.12<-readOGR("D:/WYO_COOP/RedDesertToHobackDataMuleDeerProject/DissertationChapters/Chapter1_GWH_AmongMigratoryStrategies/Data/WinterRange/KUDs","PopLevel_WinterSeasonalRanges_95KUD_2012")
d.14<-readOGR("D:/WYO_COOP/RedDesertToHobackDataMuleDeerProject/DissertationChapters/Chapter1_GWH_AmongMigratoryStrategies/Data/WinterRange/KUDs","PopLevel_WinterSeasonalRanges_95KUD_2014")
d.16<-readOGR("D:/WYO_COOP/RedDesertToHobackDataMuleDeerProject/DissertationChapters/Chapter1_GWH_AmongMigratoryStrategies/Data/WinterRange/KUDs","PopLevel_WinterSeasonalRanges_95KUD_2016")
d.17<-readOGR("D:/WYO_COOP/RedDesertToHobackDataMuleDeerProject/DissertationChapters/Chapter1_GWH_AmongMigratoryStrategies/Data/WinterRange/KUDs","PopLevel_WinterSeasonalRanges_95KUD_2017")
d.18<-readOGR("D:/WYO_COOP/RedDesertToHobackDataMuleDeerProject/DissertationChapters/Chapter1_GWH_AmongMigratoryStrategies/Data/WinterRange/KUDs","PopLevel_WinterSeasonalRanges_95KUD_2018")
d.19<-readOGR("D:/WYO_COOP/RedDesertToHobackDataMuleDeerProject/DissertationChapters/Chapter1_GWH_AmongMigratoryStrategies/Data/WinterRange/KUDs","PopLevel_WinterSeasonalRanges_95KUD_2019")
d.20<-readOGR("D:/WYO_COOP/RedDesertToHobackDataMuleDeerProject/DissertationChapters/Chapter1_GWH_AmongMigratoryStrategies/Data/WinterRange/KUDs","PopLevel_WinterSeasonalRanges_95KUD_2020")
...
#Clip date of peak IRG to population level winter ranges to determine
#mean date of peak IRG for each year
...
#Mean date of peak IRG across all winter ranges combined:
#119 for 2011
#105 for 2012
#108 for 2014
#103 for 2016
